...
CREATE TABLE `pagamento_cartao` (
  ...
  `numero_cartao` char(16) DEFAULT NULL,
  `valor` decimal(10,2) NOT NULL,
  `fk_id_pagamento` int NOT NULL,
  PRIMARY KEY (`id_cartao`),
  KEY `fk_cartao_pagamento` (`fk_id_pagamento`),
  CONSTRAINT `fk_cartao_pagamento` FOREIGN KEY (`fk_id_pagamento`) REFERENCES `pagamento` (`id_pagamento`)
...
-- Dump completed on 2025-09-27 22:14:47
